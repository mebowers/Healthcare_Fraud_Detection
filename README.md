...
## Data Overview
The data comes from Kaggle's [Healthcare Provider Fraud Detection Analysis](https://www.kaggle.com/datasets/rohitrox/healthcare-provider-fraud-detection-analysis) Train_ datasets. 

[Provider-level data](provider_level_data.csv), created for modeling 
[Capstone data dictionary](Capstone_data_dictionary.pdf), created by author
